...
const Card = ({image}) => {
  ...
  return (
    ...
    }} className={`cursor-pointer hover:scale-110 hover:shadow-2xl hover:rotate-1 transition-all duration-500 rounded-2xl overflow-hidden bg-gray-800/50 backdrop-blur-sm relative group ${selectedImage === image ? 'border-4 border-white shadow-2xl shadow-white/50' : 'border border-gray-700'}`} >
